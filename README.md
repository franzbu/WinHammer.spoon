...
However, LattinMellon also does away with the second limitation, namely having to use a canvas. LattinMellon is still in early development state; therefore, the occational unexpected hiccup should be forgiven.
